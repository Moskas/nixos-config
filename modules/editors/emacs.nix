...

{
  ...
  # Nix-colors theme
  xdg.configFile."doom/themes/doom-nix-colors-theme.el".text = ''
    ...
    (def-doom-theme doom-homage-white
                    ...
                    ((bg         '("#${config.colorScheme.palette.base00}" nil       nil            ))
                     (bg-alt     '("#${config.colorScheme.palette.base01}" nil       nil            ))
                     (base0      '("#${config.colorScheme.palette.base00}" "#${config.colorScheme.palette.base00}" "white"        ))
                     (base1      '("#${config.colorScheme.palette.base01}" "#${config.colorScheme.palette.base01}" "brightblack"  ))
                     (base2      '("#${config.colorScheme.palette.base01}" "#${config.colorScheme.palette.base01}" "brightblack"  ))
